// let a = Number(prompt("Nhập số bất kì lớn hơn 2:"))
// let b = Number(prompt("Nhập số bất kì"))
// let c = Number(prompt("Nhập số bất kì"))
...
// let a1 = Number(prompt("Nhập số bất kì: "));
// let a2 = Number(prompt("Nhập số bất kì"));
// let a3 = Number(prompt("Nhập số bất kì"));
